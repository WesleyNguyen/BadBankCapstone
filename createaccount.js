function CreateAccount(){
  ...
  const ctx = React.useContext(UserContext);  //Removed due to refactor with database
  ...
  function handleCreate(){
    ...
    (async () => {
      ...
      console.log("CreateAcc Res's Status: " + res.status)
...
//    console.log(JSON.stringify(ctx));
  ...
  return (
    <Card
      ...
      body={show ? (  
              <>
              Newly Created User: {ctx.data[0].name}<br/>
              Name<br/>
